# Claude AI Instructions for Carpe Diem

This file provides high-level guidelines and instructions for Claude models interacting with this codebase. For full technical details and coding standards, refer to the main [GUIDELINES.md](GUIDELINES.md) file.
