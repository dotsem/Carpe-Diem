...
void main() {
  group('tags', () {
    testWidgets(
      'TagHighlightingController highlights existing tags in primary color and new tags in grey',
      (tester) async {
        ...
        expect(
          textSpan.children![1].style!.fontWeight,
        ...
        expect(
          textSpan.children![3].style!.fontWeight,
          equals(FontWeight.bold),
        );
      },
    );
