...
[issues](https://github.com/dotsem/Carpe-Diem/issues). Before
...
If the bug has not been resolved or reported previously, then it is time to [create a new issue](https://github.com/dotsem/Carpe-Diem/issues/new). In the issue title try to summarize the problem by avoiding generic phrases like *"System Failure"* or *"Installation Problems"*.
...
2. Also make sure the idea is not already listed in the [issues](https://github.com/dotsem/Carpe-Diem/issues);
...
After having examined all these questions, you can [create a new issue](https://github.com/dotsem/Carpe-Diem/issues/new) describing the enhancements. Use the label **enhancement**.
...
To create your feature request [create a new issue](https://github.com/dotsem/Carpe-Diem/issues/new) using the label **feature**.
