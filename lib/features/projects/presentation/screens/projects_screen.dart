...
class _ProjectsScreenState extends ConsumerState<ProjectsScreen> {
  ...
  Widget build(BuildContext context) {
    return ProjectsShortcuts(
      onMoveNext: () => _gridKey.currentState?.moveFocus(0, 1),
      onMovePrev: () => _gridKey.currentState?.moveFocus(0, -1),
      onMoveLeft: () => _gridKey.currentState?.moveFocus(-1, 0),
      onMoveRight: () => _gridKey.currentState?.moveFocus(1, 0),
